...
import { AuthServiceMock, jwtUserMock, mockAuthService } from 'test/mocks/auth';
import { CookiesServiceMock, mockCookiesService } from 'test/mocks/cookies';
import { JwtUser, UserInfo } from '@repo/shared/types';
...
describe('AuthController', () => {
	...
	let cookiesService: CookiesServiceMock;
	...
	const makeReq = (user: JwtUser): Request & { user: JwtUser } =>
		({ user }) as Request & { user: JwtUser };

	const expectSuccess = (result: any, message: string, userInfo?: UserInfo) => {
