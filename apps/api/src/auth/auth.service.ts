...
import { AuthData, User, UserByQuery, UserInfo } from '@repo/api/auth/types';
...
export class AuthService {
  ...
  async signup(email: string, password: string): Promise<AuthData> {
  ...
  async getAccountInfo(id: string): Promise<UserInfo> {
