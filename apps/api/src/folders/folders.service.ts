...
export class FoldersService {
  ...
  async getFolders(payload: GetFoldersPayload): Promise<GetFoldersResponse> {
  ...
  async deleteFolder(id: string, socketId?: string): Promise<Folder> {
